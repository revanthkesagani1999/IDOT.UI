  ...
  private calculateDefaultValues(): void {
    ...
    if (this.equipment!== undefined &&  this.ModelYear !== undefined)      
      ...
      console.log('claculating...')
        this.equipment.Current_Market_Year_Resale_Value = Math.round(Math.max(
          this.equipment.Original_price - ((2004 - this.ModelYear) * this.equipment.Original_price * (1 - this.equipment.Salvage_Value)) / (this.equipment.Economic_Life_in_months / 12),
